	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              ...
	              React.createElement("img", { alt: "Switchboard header logo", src: "big-logo.png", width: 35, height: 35 })
	            ),
	            React.createElement(
	              "div",
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              "div",
	              { className: cx({ alert: true, "alert-success bg-brand-4": healthyCount === backends.length, "alert-error": healthyCount !== backends.length }) },
	              React.createElement(
	                "div",
	                { className: "media" },
	                React.createElement(
