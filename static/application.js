...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Backends = __webpack_require__(5);
	...
	var setCorrectingInterval = _require.setCorrectingInterval;
	...
	var Application = React.createClass({
	  ...
	  updateBackends: function updateBackends() {
	    request.get("/v0/backends").accept("json").end((function (err, _ref) {
	      var backends = _ref.body;
	  ...
	  pollBackends: function pollBackends() {
	    this.updateBackends();
	  ...
	  render: function render() {
	    ...
	    var healthyCount = backends && backends.reduce(function (memo, b) {
	      return memo + (b.healthy ? 1 : 0);
	    }, 0);
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        "div",
	        { className: "main container-fluid pvm bg-dark-1" },
	        React.createElement(
	          "div",
	          { className: "container pvn mvn" },
	          React.createElement(
	            "div",
	            { className: "media" },
	            React.createElement(
	              ...
	              React.createElement("img", { alt: "Switchboard header logo", src: "switchboard-header-logo.png", width: 40, height: 40 })
	            ),
	            React.createElement(
	              "div",
	              ...
	              React.createElement(
	                "h1",
	                { className: "h3 man pts type-neutral-8" },
	                "Switchboard"
	              )
	            )
	          )
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              "div",
	              { className: cx({ alert: true, "alert-success bg-brand-4": healthy, "alert-error": !healthy }) },
	              React.createElement(
	                "div",
	                { className: "media" },
	                React.createElement(
	                  ...
	                  React.createElement("i", { className: cx({ fa: true, "fa-check-circle": healthy, "fa-exclamation-triangle": !healthy }) })
	                ),
	                React.createElement(
	                  "div",
	                  { className: "media-body em-high" },
	                  healthText
	                )
	              )
	            )
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              "div",
	              { className: "col-sm-24 mtl" },
	              React.createElement(Backends, { backends: backends })
	            )
	          )
	        )
	      )
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(7);
	var sortBy = __webpack_require__(169);
	...
	var Backends = React.createClass({
	  ...
	  renderBackends: function renderBackends() {
	    var backends = this.props.backends;
	
	    return backends && sortBy(backends, function (b) {
	      return b.name;
	    }).map(function (backend, i) {
	      return React.createElement(Backend, { backend: backend, key: i });
	    });
	  },
	  ...
	  render: function render() {
	    return React.createElement(
	      "table",
	      { className: "table table-data table-light man" },
	      React.createElement(
	        "thead",
	        null,
	        React.createElement(
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Backend = React.createClass({
	  ...
	  render: function render() {
	    var _props$backend = this.props.backend;
	    var name = _props$backend.name;
	    var healthy = _props$backend.healthy;
	    var currentSessionCount = _props$backend.currentSessionCount;
	    var host = _props$backend.host;
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            "span",
	            { className: cx({ "label label-primary mlm plm": true, "bg-error-2": !healthy }) },
	            React.createElement("i", { className: cx({ "fa fa-fw": true, "fa-check": healthy, "fa-remove": !healthy }) }),
	            " ",
	            healthText
	          ),
	          " "
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if ("production" !== process.env.NODE_ENV) {
	  ...
	  React.addons.TestUtils = __webpack_require__(168);
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ReactLink = __webpack_require__(11);
	var ReactStateSetters = __webpack_require__(157);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var deprecated = __webpack_require__(78);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var escapeTextForBrowser = __webpack_require__(16);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var emptyFunction = __webpack_require__(19);
	var invariant = __webpack_require__(15);
	var joinClasses = __webpack_require__(47);
	var warning = __webpack_require__(18);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ReactEventEmitterMixin = __webpack_require__(71);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ReactDOMSelection = __webpack_require__(95);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getNodeForCharacterOffset = __webpack_require__(96);
	var getTextContentAccessor = __webpack_require__(97);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var createArrayFrom = __webpack_require__(113);
	var getMarkupWrap = __webpack_require__(115);
	var invariant = __webpack_require__(15);
...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 */
	var baseCallback = __webpack_require__(170),
	    baseCompareAscending = __webpack_require__(179),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var baseIsEqual = __webpack_require__(171),
	    bindCallback = __webpack_require__(177),
	    isArray = __webpack_require__(172),
	    pairs = __webpack_require__(178);
	...
	var Body = React.createClass({
	  ...
	  render: function render() {
	    ...
	    scripts = scripts.map(function (src, i) {
	      return React.createElement("script", { type: "text/javascript", src: src, key: i });
	    });
	    var Entry = React.createFactory(entry);
	    var __html = React.renderToString(Entry({ config: config }));
	    ...
	    return React.createElement(
	      ...
	      React.createElement("script", { type: "text/javascript", dangerouslySetInnerHTML: { __html: configScript } }),
	      scripts
	    );
	  }
	});
	...
	var Layout = React.createClass({
	  ...
	  statics: {
	    init: function init(Entry) {
	      if (typeof document !== "undefined") {
	        React.render(React.createElement(Entry, { config: switchboard.config }), root);
	      }
	    }
	  },
	  ...
	  render: function render() {
	    ...
	    stylesheets = stylesheets.map(function (href, i) {
	      return React.createElement("link", { rel: "stylesheet", type: "text/css", href: href, key: i });
	    });
